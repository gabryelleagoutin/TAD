...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Filter 16S sequences based on selected genomes and extract unique taxonomies.',
    ...
    parser.add_argument('--fasta_file', required=True, help='Path to the input FASTA file containing 16S sequences.')
    parser.add_argument('--output_file', required=True, help='Path to the output file for filtered sequences.')
    parser.add_argument('--name_file', default='name_seq_16S.txt', help='Path to the output file where sequence names with taxonomy will be saved.')
    ...
    uniq_taxonomy_file = 'uniq_taxonomy_16S.txt'
