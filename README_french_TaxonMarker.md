...
On peut donc essayer d'aller 0 fond sur les paramètres du genre:
...
Nous aurons plusieurs sortie:

- Le fichier fasta filtré : filtered_16S.fna
- name_seq_16S.txt : les informations sur la taxonomie de chaque sequence
- process.log ou nous aurons a la fin le "Number of unique taxonomies". Il nous indique le nombre d'espèce qui possèdent un 16S

exemple: on a 365 taxonomie différente pour les lactobacillus et là on obtient 353 espèces avec un 16S.


On formate le fasta obtenu avec uniquement les séquences 16S du rang selectionner avec obiconvert
