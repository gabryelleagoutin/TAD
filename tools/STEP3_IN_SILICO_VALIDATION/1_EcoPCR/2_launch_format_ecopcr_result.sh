...
#GENERAL
python ../script_treatment_ecopcr_result/format_ecopcr_result.py -o analysis_[PRIMER_FOLDER] -t $PATH_BD_ECOPCR/name_seq_with_taxo.txt results/[PRIMER_FOLDER]/*ecopcr
